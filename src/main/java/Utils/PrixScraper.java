...
public class PrixScraper {

    public static String getPrixPourProduit(String nomRecherche) {
            String nomFr = TraductionUtils.traduire(nomRecherche);
            return PrixCache.getPrix(nomFr);
        }
        ...
        /*try {
            ...
            String nomFr = TranslateAPI.traduire(nomRecherche, "en", "fr");
            ...
            for (Element produit : produits) {
                ...
                if (nom.toLowerCase().contains(nomFr.toLowerCase()))
                {
                    return prix;
                }
            }
